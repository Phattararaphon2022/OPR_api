...
{
    public class cls_ctTRAttTimeshift
    {
        string Message = string.Empty;

        cls_ctConnection Obj_conn = new cls_ctConnection();

        public cls_ctTRAttTimeshift() { }
        ...
        private List<cls_TRTimeshift> getData(string condition)
        {
            ...
            try
            {
                ...
                //
                obj_str.Append(" LEFT JOIN ATT_TR_LOSTWAGES ON ATT_TR_LOSTWAGES.COMPANY_CODE=ATT_TR_TIMESHIFT.COMPANY_CODE  AND ATT_TR_LOSTWAGES.WORKER_CODE=ATT_TR_TIMESHIFT.WORKER_CODE");
                //
        ...
        public List<cls_TRTimeshift> getDataByFillter(int id, string com, string emp, DateTime datefrom, DateTime dateto)
        {
            string strCondition = "";
            if (!id.Equals(0))
                strCondition += " AND ATT_TR_TIMESHIFT.TIMESHIFT_ID='" + id + "'";
            if (!com.Equals(""))
        ...
        public List<cls_TRTimeshift> getDataByFillterLostwages(int id, string com, string cardno, DateTime datefrom, DateTime dateto)
        {
            string strCondition = "";
            if (!id.Equals(0))
                strCondition += " AND ATT_TR_TIMESHIFT.TIMESHIFT_ID='" + id + "'";
