...
{
    public class cls_ctTRAttTimeDaytype
    {
        string Message = string.Empty;

        cls_ctConnection Obj_conn = new cls_ctConnection();

        public cls_ctTRAttTimeDaytype() { }
        ...
        private List<cls_TRTimedaytype> getData(string condition)
        {
            ...
            try
            {
                ...
                obj_str.Append(", ISNULL(ATT_TR_TIMEDAYTYPE.REASON_CODE, '') AS REASON_CODE");
                ...
                obj_str.Append(", ISNULL(ATT_TR_TIMEDAYTYPE.MODIFIED_BY, ATT_TR_TIMEDAYTYPE.CREATED_BY) AS MODIFIED_BY");
                obj_str.Append(", ISNULL(ATT_TR_TIMEDAYTYPE.MODIFIED_DATE, ATT_TR_TIMEDAYTYPE.CREATED_DATE) AS MODIFIED_DATE");
                obj_str.Append(", ISNULL(ATT_TR_TIMEDAYTYPE.FLAG, 0) AS FLAG ");
                //
                obj_str.Append(", ATT_TR_LOSTWAGES.LOSTWAGES_CARDNO");
                //
                obj_str.Append(" FROM ATT_TR_TIMEDAYTYPE");
                obj_str.Append(" INNER JOIN EMP_MT_WORKER ON EMP_MT_WORKER.COMPANY_CODE=ATT_TR_TIMEDAYTYPE.COMPANY_CODE");
                obj_str.Append(" AND EMP_MT_WORKER.WORKER_CODE=ATT_TR_TIMEDAYTYPE.WORKER_CODE");
                obj_str.Append(" INNER JOIN EMP_MT_INITIAL ON EMP_MT_INITIAL.INITIAL_CODE=EMP_MT_WORKER.WORKER_INITIAL");
                obj_str.Append(" INNER JOIN SYS_MT_REASON ON ATT_TR_TIMEDAYTYPE.COMPANY_CODE=SYS_MT_REASON.COMPANY_CODE");
                obj_str.Append(" AND SYS_MT_REASON.REASON_CODE=ATT_TR_TIMEDAYTYPE.REASON_CODE AND SYS_MT_REASON.REASON_GROUP = 'DAT'");
                //
                obj_str.Append(" LEFT JOIN ATT_TR_LOSTWAGES ON ATT_TR_LOSTWAGES.COMPANY_CODE=ATT_TR_TIMEDAYTYPE.COMPANY_CODE  AND ATT_TR_LOSTWAGES.WORKER_CODE=ATT_TR_TIMEDAYTYPE.WORKER_CODE");
                //
        ...
        public List<cls_TRTimedaytype> getDataByFillter(string com, int id, string cardno, string datefrom, string dateto)
        {
            string strCondition = "";
            if (!com.Equals(""))
                strCondition += " AND ATT_TR_TIMEDAYTYPE.COMPANY_CODE='" + com + "'";
            ...
            if (!cardno.Equals(""))
                strCondition += " AND ATT_TR_TIMEDAYTYPE.WORKER_CODE='" + cardno + "'";

            

            return this.getData(strCondition);
        }
        public List<cls_TRTimedaytype> getDataByFillterLostwages(string com, int id, string worker_code, string datefrom, string dateto)
        {
            string strCondition = "";
            if (!com.Equals(""))
                strCondition += " AND ATT_TR_TIMEDAYTYPE.COMPANY_CODE='" + com + "'";
        ...
        public bool delete(string com, int id, string worker_code)
        {
            ...
            try
            {
                ...
                obj_str.Append(" DELETE FROM ATT_TR_TIMEDAYTYPE");
                obj_str.Append(" WHERE 1=1 ");
                if (!com.Equals(""))
        ...
        public string insert(cls_TRTimedaytype model)
        {
            string blnResult = "";
            try
            {
                ...
                obj_str.Append("INSERT INTO ATT_TR_TIMEDAYTYPE");
                obj_str.Append(" (");
        ...
        public string update(cls_TRTimedaytype model)
        {
            string blnResult = "";
            try
            {
                ...
                obj_str.Append("UPDATE ATT_TR_TIMEDAYTYPE SET ");
