    ...
    public class cls_ctTRWageday
    {
        ...
        private List<cls_TRWageday> getData(string language, string condition)
        {
            ...
            try
            {
                ...
                obj_str.Append(" INNER JOIN HRM_MT_WORKER ON HRM_MT_WORKER.COMPANY_CODE=ATT_TR_WAGEDAY.COMPANY_CODE AND HRM_MT_WORKER.WORKER_CODE=ATT_TR_WAGEDAY.WORKER_CODE");
