...
{
    public class cls_ctMTProuniform
    {
        string Message = string.Empty;

        cls_ctConnection Obj_conn = new cls_ctConnection();

        public cls_ctMTProuniform() { }

        public string getMessage() { return this.Message.Replace("PRO_MT_PROUNIFORM", "").Replace("cls_ctMTProuniform", "").Replace("line", ""); }
        ...
        private List<cls_MTProuniform> getData(string condition)
        {
            List<cls_MTProuniform> list_model = new List<cls_MTProuniform>();
            cls_MTProuniform model;
            try
            {
                ...
                obj_str.Append(" ORDER BY prouniform_CODE");
        ...
        public int getNextID()
        {
            ...
            try
            {
                ...
                obj_str.Append("SELECT ISNULL(PROUNIFORM_ID, 1) ");
                obj_str.Append(" FROM PRO_MT_PROUNIFORM");
                obj_str.Append(" ORDER BY PROUNIFORM_ID DESC ");
        ...
        public string insert(cls_MTProuniform model)
        {
            string strResult = "";
            try
            {
                ...
                obj_cmd.Parameters.Add("@PROUNIFORM_NAME_TH", SqlDbType.VarChar); obj_cmd.Parameters["@PROUNIFORM_NAME_TH"].Value = model.prouniform_name_th;
                obj_cmd.Parameters.Add("@PROUNIFORM_NAME_EN", SqlDbType.VarChar); obj_cmd.Parameters["@PROUNIFORM_NAME_EN"].Value = model.prouniform_name_en;
                ...
                obj_conn.doClose();
                strResult = model.prouniform_id.ToString();
            }
            catch (Exception ex)
            {
        ...
        public bool update(cls_MTProuniform model)
        {
            bool blnResult = false;
            try
            {
                cls_ctConnection obj_conn = new cls_ctConnection();
                System.Text.StringBuilder obj_str = new System.Text.StringBuilder();
                obj_str.Append("UPDATE PRO_MT_PROUNIFORM SET ");
                obj_str.Append(" PROUNIFORM_NAME_TH=@PROUNIFORM_NAME_TH ");
                obj_str.Append(", PROUNIFORM_NAME_EN=@PROUNIFORM_NAME_EN ");
                obj_str.Append(", MODIFIED_BY=@MODIFIED_BY ");
                obj_str.Append(", MODIFIED_DATE=@MODIFIED_DATE ");
                obj_str.Append(" WHERE PROUNIFORM_ID=@PROUNIFORM_ID ");
