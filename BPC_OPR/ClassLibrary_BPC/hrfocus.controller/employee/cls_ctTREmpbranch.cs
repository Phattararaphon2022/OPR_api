...
namespace ClassLibrary_BPC.hrfocus.controller
{
    public class cls_ctTREmpbranch
    {
        ...
        public List<cls_TREmpbranch> getDataTaxMultipleEmp(string com, string worker)
        {
        ...
        public bool checkDataOld(string com, string emp, string id)
        {
            ...
            try
            {
                ...
                {
                    obj_str.Append(" AND BRANCH_CODE='" + id + "' ");
                }
        ...
        public bool insert(cls_TREmpbranch model)
        {
            ...
            try
            {
                ...
                //-- Check data old
                if (this.checkDataOld(model.company_code, model.worker_code,model.branch_code))
                {
