...
namespace ClassLibrary_BPC.hrfocus.controller
{
    public class cls_ctMTPosition
    {
        ...
        public List<cls_MTPosition> getDataByFillter(string code,string com)
        {
            string strCondition = "";
        ...
        public bool checkDataOld(string id,string code)
        {
            ...
            try
            {
                ...
                obj_str.Append(" FROM EMP_MT_POSITION");
                obj_str.Append(" WHERE POSITION_ID='" + id + "'");
        ...
        public string insert(cls_MTPosition model)
        {
            ...
            try
            {
                ...
                //-- Check data old
                if (this.checkDataOld(model.position_id.ToString(),model.position_code))
                {
