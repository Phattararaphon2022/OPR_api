...
{
    public class cls_ctTRReduce
    {
        string Message = string.Empty;

        cls_ctConnection Obj_conn = new cls_ctConnection();

        public cls_ctTRReduce() { }

        public string getMessage() { return this.Message.Replace("EMP_TR_REDUCE", "").Replace("cls_ctTRReduce", "").Replace("line", ""); }
        ...
        private List<cls_TRReduce> getData(string condition)
        {
            List<cls_TRReduce> list_model = new List<cls_TRReduce>();
            cls_TRReduce model;
            try
            {
                ...
                obj_str.Append(" FROM EMP_TR_REDUCE");
            ...
            {
                Message = "EMPRED001:" + ex.ToString();
            }

            return list_model;
        }

        public List<cls_TRReduce> getDataByFillter(string com, string emp)
        {
            string strCondition = "";
        ...
        public int getNextID()
        {
            ...
            try
            {
                ...
                obj_str.Append("SELECT ISNULL(EMPREDUCE_ID, 1) ");
                obj_str.Append(" FROM EMP_TR_REDUCE");
                obj_str.Append(" ORDER BY EMPREDUCE_ID DESC ");
        ...
        public bool delete(string com, string emp)
        {
            ...
            try
            {
                ...
                obj_str.Append("DELETE FROM EMP_TR_REDUCE");
                obj_str.Append(" WHERE COMPANY_CODE='" + com + "' ");
                obj_str.Append(" AND WORKER_CODE='" + emp + "' ");
         ...
         public bool insert(cls_TRReduce model)
        {
            ...
            try
            {
                ...
                //-- Check data old
                if (this.checkDataOld(model.company_code, model.worker_code,model.empreduce_id.ToString()))
                {
                ...
                obj_str.Append("INSERT INTO EMP_TR_REDUCE");
                obj_str.Append(" (");
                obj_str.Append("COMPANY_CODE ");
                obj_str.Append(", WORKER_CODE ");
                ...
                obj_conn.doClose();
                blnResult = true;
                strResult = model.empreduce_id.ToString();
            }
            catch (Exception ex)
            {
                Message = "EMPRED005:" + ex.ToString();
                strResult = "";
            }
        ...
        public bool update(cls_TRReduce model)
        {
            bool blnResult = false;
            try
            {
                cls_ctConnection obj_conn = new cls_ctConnection();
                System.Text.StringBuilder obj_str = new System.Text.StringBuilder();
                obj_str.Append("UPDATE EMP_TR_REDUCE SET ");
                ...
                obj_str.Append(" AND EMPREDUCE_ID=@EMPREDUCE_ID ");
