...
namespace ClassLibrary_BPC.hrfocus.controller
{
    public class cls_ctMTLocation
    {
        ...
        public string getMessage() { return this.Message.Replace("EMP_MT_LOCATION", "").Replace("cls_ctMTLocation", "").Replace("line", ""); }
        ...
        private List<cls_MTLocation> getData(string condition)
        {
            ...
            try
            {
                ...
                obj_str.Append(" FROM EMP_MT_LOCATION");
        ...
        public bool delete(string code)
        {
            ...
            try
            {
                ...
                obj_str.Append("DELETE FROM EMP_MT_LOCATION");
                obj_str.Append(" WHERE LOCATION_CODE='" + code + "'");
        ...
        public string insert(cls_MTLocation model)
        {
            ...
            try
            {
                ...
                obj_str.Append("INSERT INTO EMP_MT_LOCATION");
                obj_str.Append(" (");
                obj_str.Append("LOCATION_ID ");
                obj_str.Append(", LOCATION_CODE ");
                obj_str.Append(", LOCATION_NAME_TH ");
        ...
        public bool update(cls_MTLocation model)
        {
            ...
            try
            {
                cls_ctConnection obj_conn = new cls_ctConnection();
                System.Text.StringBuilder obj_str = new System.Text.StringBuilder();
                obj_str.Append("UPDATE EMP_MT_LOCATION SET ");
